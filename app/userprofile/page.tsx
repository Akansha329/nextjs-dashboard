...
<div className="w-64 bg-white shadow-lg p-6 flex flex-col">
  ...
  <Link href="/dashboard" className="mb-2 text-left hover:text-blue-500">
    Dashboard
  </Link>
  
  <Link href="/weather" className="mb-2 text-left hover:text-blue-500">
    Weather
  </Link>
  
  <Link href="/userprofile" className="mb-2 text-left hover:text-blue-500">
    Profile
  </Link>
</div>
